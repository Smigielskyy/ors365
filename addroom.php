...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>ORS365 - Sale operacyjne</title>
        <meta charset="UTF-8">
					...
					<body>
						<br><div class="container"> 
							<div class="row">
								<div class="col-lg-6">
									<div class="jumbotron">
										<!--Tutaj możesz dodać sale operacyjną -->
										<form class="form-horizontal" method= "post" action="add.room.php">
											<fieldset>
												<legend>Sala Operacyjna</legend>
												<div class="form-group">
													<label class="col-md-4 control-label" for="room">Numer OR</label>  
													<div class="col-md-5">
