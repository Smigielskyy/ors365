...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>ORS365 - Kalendarz operacji</title>
        <meta charset="UTF-8">
            ...
            <div class="text">
                ...
                <html lang="en" dir="ltr">
                    ...
                    <body>
                        <br><div align="center">
                            <fieldset>
                            <legend>Kalendarz operacji</legend>
                                <?php
                                    echo "<tr>
                                            <td>";
                                // łączenie do bazy
                                ...
                                if(!$sql)
                                {
                                    ...
                                    alert("Kalendarz został pomyślnie usunięty");
                ...
                <div align="center">
                <br>
                <a href="home.php"><input type='submit' class='btn btn-success' name='add' value='Dodaj'></a>
                </div>
                </div>
                    </body>
                    </html>
