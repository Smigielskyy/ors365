                    ...
                    <body>
                        <br><div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="jumbotron">
                                        <!--Tutaj możesz dodać pacjenta-->
                                        <form class="form-horizontal" method= "post" action = "add.patient.php">
                                            <fieldset>
                                                <legend>Dodaj pacjenta</legend>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="patientname">Imię i nazwisko</label>  
                                                    <div class="col-md-5">
                                                        <input id="patientname" name="patientname" type="text" placeholder="" class="form-control input-md" required="">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="patientcode">PESEL</label>  
                                                    <div class="col-md-5">
                                                        <input id="patientcode" name="patientcode" type="text" placeholder="" class="form-control input-md" required="">	
                                                    </div>
                                                </div>
