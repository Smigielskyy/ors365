					...
					<body>
						<br><div class="container"> 
							<div class="row">
								<div class="col-lg-6">
									<div class="jumbotron">
										<!--Tutaj możesz dodać czas operacji -->
										<form class="form-horizontal" method= "post" action="add.time.php">
											<fieldset>
												<legend>Ustaw czas</legend>
												<div class="form-group">
													<label class="col-md-4 control-label" for="starttime">Planowana godzina rozpoczęcia</label>  
													<div class="col-md-5">
												...
												<div class="form-group">
													<label class="col-md-4 control-label" for="endtime">Planowana godzina zakończenia</label>  
													<div class="col-md-5">
